...
package com.hapag.kubo2dao.impl;

import com.hapag.kubo.dao.TodaysMenuDAO;
import static com.hapag.kubo2dao.impl.DBConnection.closeConnection;
import static com.hapag.kubo2dao.impl.DBConnection.getCon;
import com.hapag.kubo.model.Category;
import com.hapag.kubo.model.TodaysMenu;
import com.hapag.kubo.util.ComboBoxList;
...
//            ps.setLong(2, category.getId());
    ...
    public ArrayList<TodaysMenu> selectTodaysMenu() {
        ArrayList<com.hapag.kubo.model.TodaysMenu> list = new ArrayList<>();
        try {
            String query = """
                           SELECT 
                              MENU.ID, 
            ...
            while (rs.next()) {
                com.hapag.kubo.model.TodaysMenu tm = new TodaysMenu();
                com.hapag.kubo.model.Category c = new com.hapag.kubo.model.Category();
                com.hapag.kubo.model.Menu m = new com.hapag.kubo.model.Menu();
...
//            closeConnection();
    ...
    @Override
    public ArrayList<com.hapag.kubo.model.TodaysMenu> getMenuList() {
        ArrayList<com.hapag.kubo.model.TodaysMenu> list = new ArrayList<>();
        try {
            String query = """
                           SELECT 
    ...
    @Override
    public void addMenuOfTheDay(com.hapag.kubo.model.Menu menu) {
        try {
            getDBConn();
...
//            c.closeConnection();
    ...
    public LinkedList<com.hapag.kubo.model.TodaysMenu> getMenuByCategoryIdMenuId(Long id) {
        LinkedList<com.hapag.kubo.model.TodaysMenu> list = new LinkedList<>();
        try {
            String query = "SELECT \n"
                    + "    TODAYS_MENU.ID,\n"
            ...
            ResultSet rs = st.executeQuery(query);
            while (rs.next()) {
                com.hapag.kubo.model.TodaysMenu tm = new com.hapag.kubo.model.TodaysMenu();
                com.hapag.kubo.model.Menu menu = new com.hapag.kubo.model.Menu();
