...
import com.hapag.kubo2dao.impl.DBConnection;
...
public class JDialogReport extends javax.swing.JDialog {
     ...
     */
    public JDialogReport(com.hapag.kubo3.gui.JFrameCafSys parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.mainMenu = parent;
        comboBoxUser();
        ComboBoxList userIdl = (ComboBoxList) this.jComboBoxUser.getSelectedItem();
        com.hapag.kubo.model.UserAccount u = new com.hapag.kubo.model.UserAccount();
    ...
    private void jComboBoxStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxStartActionPerformed
        try {
            com.hapag.kubo.model.Invoice invoice = new com.hapag.kubo.model.Invoice();
            ComboBoxList userIdl = (ComboBoxList) this.jComboBoxUser.getSelectedItem();
            com.hapag.kubo.model.UserAccount user = new com.hapag.kubo.model.UserAccount();
